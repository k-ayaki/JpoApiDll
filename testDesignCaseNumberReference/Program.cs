...
namespace testDesignCaseNumberReference
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DesignCaseNumberReference tj = new DesignCaseNumberReference("application", "2016500748", at.m_access_token.access_token);
            Console.WriteLine("■意匠番号参照 application 2016500748");
            if (tj.m_error == tj.e_NONE)
            {
                ...
                Console.WriteLine("国際登録番号：" + tj.m_result.data.internationalRegistrationNumber);
                Console.WriteLine("意匠番号：" + tj.m_result.data.designNumber);
            }
