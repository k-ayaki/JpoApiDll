...
namespace testTrademarkPriorityRightAppInfo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            TrademarkPriorityRightAppInfo tj4 = new TrademarkPriorityRightAppInfo("2020089151", at.m_access_token.access_token);
            Console.WriteLine("■商標優先基礎出願情報　2020089151");
