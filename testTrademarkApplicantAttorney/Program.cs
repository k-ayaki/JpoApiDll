...
namespace testTrademarkApplicantAttorney
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            TrademarkApplicantAttorney tj = new TrademarkApplicantAttorney("株式会社日立製作所", at.m_access_token.access_token);
            Console.WriteLine("■商標申請人コード取得 株式会社日立製作所");
