...
namespace testDesignApplicantAttorney
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DesignApplicantAttorney tj = new DesignApplicantAttorney("株式会社日立製作所", at.m_access_token.access_token);
            Console.WriteLine("■意匠申請人コード取得 株式会社日立製作所");
