...
namespace testDesignApplicantAttorneyCd
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DesignApplicantAttorneyCd tj2 = new DesignApplicantAttorneyCd("000001199", at.m_access_token.access_token);
            Console.WriteLine("■意匠申請人氏名・名称取得 000001199");
