...
namespace testDesignRegistrationInfo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DesignRegistrationInfo tj4 = new DesignRegistrationInfo("2022012584", at.m_access_token.access_token);
            Console.WriteLine("■意匠登録情報取得　2022012584");
