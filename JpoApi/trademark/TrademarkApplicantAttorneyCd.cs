...
namespace JpoApi
{
    public class TrademarkApplicantAttorneyCd : IDisposable
    {
        ...
        private class CDesignApplicantAttorneyCd
        {
        ...
        public TrademarkApplicantAttorneyCd(string applicationNumber, string a_access_token = "")
        {
            try
            {
                ...
                {
                    this.m_response = responseCache.GetJson("api/trademark/v1/applicant_attorney_cd/" + applicationNumber);
                    this.m_responseFile = responseCache.m_responseFilePath;
                    this.m_error = responseCache.m_error;

                    if (m_response.Length > 0)
                    {
                        CDesignApplicantAttorneyCd jsonObj = JsonConvert.DeserializeObject<CDesignApplicantAttorneyCd>(m_response);
