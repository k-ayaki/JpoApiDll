...
namespace JpoApi
{
    public class TrademarkRegistrationInfo : IDisposable
    {
        ...
        public class CData
        {
            ...
            public string trademarkForDisplay { get; set; }      // 意匠に係る物品
        ...
        private class CTrademarkRegistrationInfo
        {
        ...
        public TrademarkRegistrationInfo(string applicationNumber, string a_access_token = "")
        {
            try
            {
                ...
                {
                    this.m_response = responseCache.GetJson("api/trademark/v1/registration_info/" + applicationNumber);
                    this.m_responseFile = responseCache.m_responseFilePath;
                    this.m_error = responseCache.m_error;

                    if (m_response.Length > 0)
                    {
                        CTrademarkRegistrationInfo jsonObj = JsonConvert.DeserializeObject<CTrademarkRegistrationInfo>(m_response);
