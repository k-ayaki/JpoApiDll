...
{
    public class DesignAppDocContRefusalReasonDecision : IDisposable
    {
        ...
        public DesignAppDocContRefusalReasonDecision(string applicationNumber, string a_access_token = "")
        {
            try
            {
        ...
        // ~DesignAppDocContRefusalReasonDecision()
        // {
