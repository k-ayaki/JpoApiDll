...
namespace JpoApi
{
    public class DesignAppDocContOpinionAmendment : IDisposable
    {
        ...
        public DesignAppDocContOpinionAmendment(string applicationNumber, string a_access_token = "")
        {
            try
            {
                ...
                {
                    docCont.GetZipXml("api/design/v1/app_doc_cont_opinion_amendment/" + applicationNumber);
        ...
        // ~DesignAppDocContOpinionAmendment()
        // {
