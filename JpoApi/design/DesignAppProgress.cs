...
{
    // 意匠経過情報
    public class DesignAppProgress : IDisposable
    {
        ...
        {
            public string parentApplicationCategory { get; set; } // 
            public string parentApplicationLawCode { get; set; } // 
 ...
 　         public CBibliographyInformation[] bibliographyInformation { get; set; } // 書類一覧（書誌）
        ...
        private class CDesignAppProgress
        {
