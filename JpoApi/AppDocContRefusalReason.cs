...
namespace JpoApi
{
    ...
    public class AppDocContRefusalReason : IDisposable    
    {
        ...
        public AppDocContRefusalReason(string applicationNumber, string a_access_token)
        {
            try
            {
                this.m_error = e_NONE;
                ...
                docCont.GetZipXml("api/patent/v1/app_doc_cont_refusal_reason/" + applicationNumber);
