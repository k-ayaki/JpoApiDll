...
namespace JpoApi
{
    ...
    public class AppDocContRefusalReasonDecision : IDisposable
    {
        ...
        public AppDocContRefusalReasonDecision(string applicationNumber, string a_access_token = "")
        {
            try
            {
                ...
                {
                    docCont.GetZipXml("api/patent/v1/app_doc_cont_refusal_reason_decision/" + applicationNumber);
